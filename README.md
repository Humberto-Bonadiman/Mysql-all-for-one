# Bem vindo ao repositório do projeto Mysql All For One
...
```javascript
  ...
  git git@github.com:Humberto-Bonadiman/Mysql-all-for-one.git
```
...
4. Para visualizar os comandos **sql** utilizados você pode abrir os arquivos **desafioN.sql**, onde N vai de 1 à 27.

O banco de dados utilizado foi o `Northwind`, que você pode ter mais informações sobre o mesmo na próxima explicação.

---

## Iniciar banco de dados `Northwind`
